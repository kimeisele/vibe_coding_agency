...
class PromptRegistry:
    ...
    def list(self, category: str | None = None, tag: str | None = None) -> list[Prompt]:
    ...
    def search(self, query: str) -> builtins.list[Prompt]:
    ...
    def report_usage(
        self, prompt_id: str, success: bool, tokens_used: int | None = None
    ):
